...
impl Metrics {
    ...
    pub fn new(_config: &Config) -> Self {
        ...
        let processing_latency_ms =
            Histogram::with_opts(processing_latency_opts).expect("Failed to create metric");
        ...
        let turn_starts = Counter::new("amwaj_turn_starts_total", "Total turn start events")
            .expect("Failed to create metric");

        let turn_ends = Counter::new("amwaj_turn_ends_total", "Total turn end events")
            .expect("Failed to create metric");
