...
mod e2e_tests {
    ...
    use amwaj_media::detection::{TurnDetectionEngine, TurnDetectionConfig, TurnEvent};
    use amwaj_media::webrtc::{WebRtcManager, RtpPacket, JitterBuffer};
    use std::sync::Arc;
    ...
    fn test_webrtc_to_audio_pipeline() {
        ...
        // Create connection
        manager.create_connection("test-session".to_string()).unwrap();
